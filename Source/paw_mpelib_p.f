...
!     =================================================================
     ...
     &           ,MPI_DOUBLE_COMPLEX,MPI_SUM,MPI_COMM_WORLD,IERR)
      ELSE IF(OPERATION.EQ.'*')THEN
        CALL MPI_ALLREDUCE(WORK,VAL,LENG &
     &           ,MPI_DOUBLE_COMPLEX,MPI_PROD,MPI_COMM_WORLD,IERR)
      ELSE IF(OPERATION.EQ.'MAX')THEN
        CALL MPI_ALLREDUCE(WORK,VAL,LENG &
     &           ,MPI_DOUBLE_COMPLEX,MPI_MAX,MPI_COMM_WORLD,IERR)
      ELSE IF(OPERATION.EQ.'MIN')THEN
        CALL MPI_ALLREDUCE(WORK,VAL,LENG &
     &           ,MPI_DOUBLE_COMPLEX,MPI_MIN,MPI_COMM_WORLD,IERR)
      ELSE
        CALL ERROR__MSG('OPERATION NOT SUPPORTED')
        CALL ERROR__STOP('MPE__COMBINE')
      END IF
...
!     =================================================================
     ...
     &           ,MPI_REAL8,MPI_SUM,MPI_COMM_WORLD,IERR)
      ELSE IF(OPERATION.EQ.'*')THEN
        CALL MPI_ALLREDUCE(WORK,VAL,LENG &
     &           ,MPI_REAL8,MPI_PROD,MPI_COMM_WORLD,IERR)
      ELSE IF(OPERATION.EQ.'MAX')THEN
        CALL MPI_ALLREDUCE(WORK,VAL,LENG &
...
!     =================================================================
     ...
     &           ,MPI_INTEGER4,MPI_SUM,MPI_COMM_WORLD,IERR)
      ELSE IF(OPERATION.EQ.'*')THEN
        CALL MPI_ALLREDUCE(WORK,VAL,LENG &
     &           ,MPI_INTEGER4,MPI_PROD,MPI_COMM_WORLD,IERR)
      ELSE IF(OPERATION.EQ.'MAX')THEN
        CALL MPI_ALLREDUCE(WORK,VAL,LENG &
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR
!     ******************************************************************
      CALL MPI_BCAST(VAL,1,MPI_DOUBLE_COMPLEX,FROMTASK-1 &
     &                ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR
!     ******************************************************************
      CALL MPI_BCAST(VAL,1,MPI_REAL8,FROMTASK-1 &
     &                ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR
!     ******************************************************************
      CALL MPI_BCAST(VAL,1,MPI_REAL4,FROMTASK-1 &
     &                ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR
!     ******************************************************************
      CALL MPI_BCAST(VAL,1,MPI_INTEGER4,FROMTASK-1 &
     &                ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR
!     ******************************************************************
      CALL MPI_BCAST(VAL,1,MPI_LOGICAL,FROMTASK-1 &
     &                ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR
!     ******************************************************************
      CALL MPI_BCAST(VAL,SIZE(VAL),MPI_DOUBLE_COMPLEX,FROMTASK-1 &
     &                ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR
!     ******************************************************************
      CALL MPI_BCAST(VAL,SIZE(VAL),MPI_REAL8,FROMTASK-1 &
     &                ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR
!     ******************************************************************
      CALL MPI_BCAST(VAL,SIZE(VAL),MPI_REAL4,FROMTASK-1 &
     &                ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR
!     ******************************************************************
      CALL MPI_BCAST(VAL,SIZE(VAL),MPI_INTEGER4,FROMTASK-1 &
     &                ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR
!     ******************************************************************
      CALL MPI_BCAST(VAL,SIZE(VAL),MPI_LOGICAL,FROMTASK-1 &
     &                ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR,IDUM
!     ******************************************************************
        CALL MPI_SEND(VAL,1,MPI_DOUBLE_COMPLEX,TOTASK-1,TAG &
     &               ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR,IDUM
!     ******************************************************************
        CALL MPI_SEND(VAL,1,MPI_REAL8,TOTASK-1,TAG &
     &               ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR,IDUM
!     ******************************************************************
        CALL MPI_SEND(VAL,1,MPI_REAL4,TOTASK-1,TAG &
     &               ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR,IDUM
!     ******************************************************************
        CALL MPI_SEND(VAL,1,MPI_INTEGER4,TOTASK-1,TAG &
     &               ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR,IDUM
!     ******************************************************************
        CALL MPI_SEND(VAL,1,MPI_LOGICAL,TOTASK-1,TAG &
     &               ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR,IDUM
!     ******************************************************************
        CALL MPI_SEND(VAL,SIZE(VAL),MPI_DOUBLE_COMPLEX,TOTASK-1,TAG &
     &               ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR,IDUM
!     ******************************************************************
        CALL MPI_SEND(VAL,SIZE(VAL),MPI_REAL8,TOTASK-1,TAG &
     &               ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR,IDUM
!     ******************************************************************
        CALL MPI_SEND(VAL,SIZE(VAL),MPI_REAL4,TOTASK-1,TAG &
     &               ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR,IDUM
!     ******************************************************************
        CALL MPI_SEND(VAL,SIZE(VAL),MPI_INTEGER4,TOTASK-1,TAG &
     &               ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)                 :: IERR,IDUM
!     ******************************************************************
        CALL MPI_SEND(VAL,SIZE(VAL),MPI_LOGICAL,TOTASK-1,TAG &
     &               ,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)            :: STAT(MPI_STATUS_SIZE)
!     ******************************************************************
        CALL MPI_RECV(VAL,1,MPI_DOUBLE_COMPLEX,FROMTASK-1,TAG &
     &               ,MPI_COMM_WORLD,STAT,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)            :: STAT(MPI_STATUS_SIZE)
!     ******************************************************************
        CALL MPI_RECV(VAL,1,MPI_REAL8,FROMTASK-1,TAG &
     &               ,MPI_COMM_WORLD,STAT,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)            :: STAT(MPI_STATUS_SIZE)
!     ******************************************************************
        CALL MPI_RECV(VAL,1,MPI_REAL4,FROMTASK-1,TAG &
     &               ,MPI_COMM_WORLD,STAT,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)            :: STAT(MPI_STATUS_SIZE)
!     ******************************************************************
        CALL MPI_RECV(VAL,1,MPI_INTEGER4,FROMTASK-1,TAG &
     &               ,MPI_COMM_WORLD,STAT,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)            :: STAT(MPI_STATUS_SIZE)
!     ******************************************************************
        CALL MPI_RECV(VAL,1,MPI_LOGICAL,FROMTASK-1,TAG &
     &               ,MPI_COMM_WORLD,STAT,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)            :: STAT(MPI_STATUS_SIZE)
!     ******************************************************************
        CALL MPI_RECV(VAL,SIZE(VAL),MPI_DOUBLE_COMPLEX,FROMTASK-1,TAG &
     &               ,MPI_COMM_WORLD,STAT,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)            :: STAT(MPI_STATUS_SIZE)
!     ******************************************************************
        CALL MPI_RECV(VAL,SIZE(VAL),MPI_REAL8,FROMTASK-1,TAG &
     &               ,MPI_COMM_WORLD,STAT,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)            :: STAT(MPI_STATUS_SIZE)
!     ******************************************************************
        CALL MPI_RECV(VAL,SIZE(VAL),MPI_REAL4,FROMTASK-1,TAG &
     &               ,MPI_COMM_WORLD,STAT,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)            :: STAT(MPI_STATUS_SIZE)
!     ******************************************************************
        CALL MPI_RECV(VAL,SIZE(VAL),MPI_INTEGER4,FROMTASK-1,TAG &
     &               ,MPI_COMM_WORLD,STAT,IERR)
      RETURN
...
!     ******************************************************************
      ...
      INTEGER(4)            :: STAT(MPI_STATUS_SIZE)
!     ******************************************************************
        CALL MPI_RECV(VAL,SIZE(VAL),MPI_LOGICAL,FROMTASK-1,TAG &
     &               ,MPI_COMM_WORLD,STAT,IERR)
      RETURN
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEC8R1')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_DOUBLE_COMPLEX,VAL,LENG1,MPI_DOUBLE_COMPLEX &
     &                  ,MPI_COMM_WORLD,IERR)
        DEALLOCATE(VAL1)
      RETURN
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSER8R1')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_REAL8,VAL,LENG1,MPI_REAL8 &
     &                  ,MPI_COMM_WORLD,IERR)
        DEALLOCATE(VAL1)
      RETURN
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSER4R1')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_REAL4,VAL,LENG1,MPI_REAL4 &
     &                  ,MPI_COMM_WORLD,IERR)
        DEALLOCATE(VAL1)
      RETURN
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEI4R1')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_INTEGER4,VAL,LENG1,MPI_INTEGER4 &
     &                  ,MPI_COMM_WORLD,IERR)
        DEALLOCATE(VAL1)
      RETURN
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEL4R1')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_LOGICAL,VAL,LENG1,MPI_LOGICAL &
     &                  ,MPI_COMM_WORLD,IERR)
        DEALLOCATE(VAL1)
      RETURN
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEC8R2')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_DOUBLE_COMPLEX,VAL,LENG1,MPI_DOUBLE_COMPLEX &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSER8R2')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_REAL8,VAL,LENG1,MPI_REAL8 &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSER4R2')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_REAL4,VAL,LENG1,MPI_REAL4 &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEI4R2')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_INTEGER4,VAL,LENG1,MPI_INTEGER4 &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEL4R2')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_LOGICAL,VAL,LENG1,MPI_LOGICAL &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEC8R3')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_DOUBLE_COMPLEX,VAL,LENG1,MPI_DOUBLE_COMPLEX &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSER8R3')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_REAL8,VAL,LENG1,MPI_REAL8 &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSER4R3')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_REAL4,VAL,LENG1,MPI_REAL4 &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEI4R3')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_INTEGER4,VAL,LENG1,MPI_INTEGER4 &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEL4R3')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_LOGICAL,VAL,LENG1,MPI_LOGICAL &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEC8R4')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_DOUBLE_COMPLEX,VAL,LENG1,MPI_DOUBLE_COMPLEX &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSER8R4')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_REAL8,VAL,LENG1,MPI_REAL8 &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSER4R4')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_REAL4,VAL,LENG1,MPI_REAL4 &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEI4R4')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_INTEGER4,VAL,LENG1,MPI_INTEGER4 &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEL4R4')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_LOGICAL,VAL,LENG1,MPI_LOGICAL &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEC8R5')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_DOUBLE_COMPLEX,VAL,LENG1,MPI_DOUBLE_COMPLEX &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSER8R5')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_REAL8,VAL,LENG1,MPI_REAL8 &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSER4R5')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_REAL4,VAL,LENG1,MPI_REAL4 &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEI4R5')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_INTEGER4,VAL,LENG1,MPI_INTEGER4 &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEL4R5')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_LOGICAL,VAL,LENG1,MPI_LOGICAL &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEC8R6')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_DOUBLE_COMPLEX,VAL,LENG1,MPI_DOUBLE_COMPLEX &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSER8R6')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_REAL8,VAL,LENG1,MPI_REAL8 &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSER4R6')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_REAL4,VAL,LENG1,MPI_REAL4 &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEI4R6')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_INTEGER4,VAL,LENG1,MPI_INTEGER4 &
...
!     ******************************************************************
        ...
        IF(LENG1*NTASKS.NE.LENG) THEN
          CALL ERROR__MSG('ARRAY SIZE NOT DIVIDABLE BY #(PROCESSORS)')
          CALL ERROR__STOP('MPE__TRANSPOSEL4R6')
        END IF
        ALLOCATE(VAL1(LENG))
        VAL1=RESHAPE(VAL,(/LENG/))
        CALL MPI_ALLTOALL(VAL1,LENG1,MPI_LOGICAL,VAL,LENG1,MPI_LOGICAL &
...
!     ******************************************************************
        LENG=1
        CALL MPI_GATHER(INVAL,LENG,MPI_DOUBLE_COMPLEX,OUTVAL,LENG,MPI_DOUBLE_COMPLEX &
     &                 ,TOTASK-1,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
        LENG=1
        CALL MPI_GATHER(INVAL,LENG,MPI_REAL8,OUTVAL,LENG,MPI_REAL8 &
     &                 ,TOTASK-1,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
        LENG=1
        CALL MPI_GATHER(INVAL,LENG,MPI_REAL4,OUTVAL,LENG,MPI_REAL4 &
     &                 ,TOTASK-1,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
        LENG=1
        CALL MPI_GATHER(INVAL,LENG,MPI_INTEGER4,OUTVAL,LENG,MPI_INTEGER4 &
     &                 ,TOTASK-1,MPI_COMM_WORLD,IERR)
      RETURN
...
!     ******************************************************************
        LENG=1
        CALL MPI_GATHER(INVAL,LENG,MPI_LOGICAL,OUTVAL,LENG,MPI_LOGICAL &
     &                 ,TOTASK-1,MPI_COMM_WORLD,IERR)
      RETURN
