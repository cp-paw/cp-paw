...
!     
      ...
      & "     ACC. SURFACE(",A4,") = ",F8.3)')NAME,&
      & RSOLV(IAT),NAME,ACCSURFACE(IAT)
      ENDDO
      WRITE(NFILO,*)
...
!     IF(THISTASK.EQ.1) THEN
        READ(NFIL)FACE_IDENT,FACE_ATOM_IDENT,FACE_MIDPOINT,&
         & FACE_TRI1,FACE_TRI2,FACE_TRI3,FACE_AREA,FACE_Q,FACE_QM,FACE_FMEM
!     END IF
      CALL MPE$BROADCAST(1,FACE_IDENT)
      CALL MPE$BROADCAST(1,FACE_ATOM_IDENT)
      CALL MPE$BROADCAST(1,FACE_MIDPOINT)
      CALL MPE$BROADCAST(1,FACE_TRI1)
      CALL MPE$BROADCAST(1,FACE_TRI2)
      CALL MPE$BROADCAST(1,FACE_TRI3)
      CALL MPE$BROADCAST(1,FACE_AREA)
      CALL MPE$BROADCAST(1,FACE_Q)
      CALL MPE$BROADCAST(1,FACE_QM)
      CALL MPE$BROADCAST(1,FACE_FMEM)
!
      DO COUNTER=1,NFACE
...
!
      ...
      CALL GET_CHARGE(NETCHARGE,INSIDE_CHARGE,POSITIVE_INTEGRAL,&
       &NEGATIVE_INTEGRAL,INSIDE_PLUS,INSIDE_MINUS)
      WRITE(NFILO,FMT='("FRIC: ",F15.9," ESOLV :",F15.9," EKINQ :", &
       & F15.9)')QFRIC,ESOLV,EKINQ
