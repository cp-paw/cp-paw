...
!     ==================================================================
dd    CALL MPE$QUERY('K',NTASKS_K,THISTASK_K)
DD    CALL MPE$ADDLAYER('G',NTASKS_K)
DD    CALL MPE$COMBINE('K','MIN',NTASKS_K,NTASKS_KX)
!     
!     ==================================================================
!     ==  DEFINE REAL SPACE GRID                                      ==
!     ==================================================================
      CALL CELL$GETR8A('TREF',9,RBAS)
DD    CALL PLANEWAVE$DIVIDERGRIDONTASKS(NTASKS_KX,EPWRHO,RBAS,NR1START,NR1L,NR2,NR3)
