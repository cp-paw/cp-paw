...
PSIM_CASES=${PSIM_CASES:-"gpu_resident gpu_psim_propagate gpu_resident_psim_phase gpu_resident_hpsi gpu_hpsi_psim_propagate gpu_resident_hpsi_psim_phase gpu_resident_hpsi_opsi gpu_resident_hpsi_opsi_psim_phase"}
