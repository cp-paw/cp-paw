...
DRY_RUN=${DRY_RUN:-no}
GPU_CASES=${GPU_CASES:-"gpu_resident gpu_resident_stack gpu_resident_stack_cufft gpu_resident_stack_serial3dfft gpu_resident_stack_serial3dfft_accmap gpu_resident_nosync gpu gpu_force_all gpu_3dfft gpu_managed gpu_unified gpu_off"}
