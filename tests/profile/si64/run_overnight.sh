...
GPU_DIAGNOSTIC_CASES=${GPU_DIAGNOSTIC_CASES:-"gpu_nosync gpu_resident_stack_cufft gpu_resident_stack_serial3dfft gpu_force_all gpu_3dfft gpu_no_cufft gpu_no_cublas gpu_no_cusolver"}
