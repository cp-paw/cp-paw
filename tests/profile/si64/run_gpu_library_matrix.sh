...
export GPU_CASES=${GPU_CASES:-"gpu_off gpu_all gpu_all_off gpu_all_resident_stack gpu_all_resident_stack_cufft gpu_resident gpu_resident_orthox_off gpu_resident_no_cusolver cublas cusolver cufft cufftw nvlamath nvblas gpu_no_cufft gpu_no_cublas gpu_no_cusolver gpu_managed gpu_unified"}
