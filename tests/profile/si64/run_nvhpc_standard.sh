...
GPU_CASES=${GPU_CASES:-"gpu_resident gpu_resident_orthox_off gpu_resident_addpro_host gpu_resident_pro_host gpu_resident_invbatch_off gpu_resident_no_cusolver"}
