...
TOOLDIR=/home/ptpb/Tree/Archive/PAW_current/src/Tools
...
ifeq (${PARALLEL},T)   #select parallel versus scalar paw_mpelib.f90
  ...
  LINK=f90   -I${OBJDIR} -L${OBJDIR}  -L/home/ptpb/Tree/Archive/PAW_current/lib/fftw-intel/fftw/.libs/ -L/home/ptpb/Tree/Archive/PAW_current/lib/ATLAS/lib/Linux_PIII -L/home/ptpb/Tree/Archive/PAW_current/lib/mpich-intel/lib
  ...
  LINK=f90   -I${OBJDIR} -L${OBJDIR}  -L/home/ptpb/Tree/Archive/PAW_current/lib/fftw-intel/fftw/.libs/ -L/home/ptpb/Tree/Archive/PAW_current/lib/ATLAS/lib/Linux_PIII 
