...
COMPILE=/opt/intel/compiler70/ia32/bin/ifc -c -mp  
#___________________________ Fortran77 compiler + compiler flags (for blas) 
COMPILE77=/opt/intel/compiler70/ia32/bin/ifc -c -mp 
...
OBJDIR=/homer/cfoerst/ARCHIVE_PAW/PAW_sandbox/bin/ifc/Objects
...
PAWX=/homer/cfoerst/ARCHIVE_PAW/PAW_sandbox/bin/ifc
