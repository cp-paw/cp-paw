...
!       ===============================================================
        ...
        END IF
        IF(FF.GT.0.D0) THEN
          WRITE(NFIL,FMT='("    !STATE  L=",I2," N=",I2," F=",F5.1," !END")')3,NF,FF
        END IF
        WRITE(NFIL,FMT='("  !END")')
...
END IF
WRITE(NFIL,FMT='("  !WAVE L=0 E=0. PSTYPE=''HBS'' RC=",F5.3," LAMBDA=6 !END")')FACTOR*RCOV
WRITE(NFIL,FMT='("  !WAVE L=1 E=0. PSTYPE=''HBS'' RC=",F5.3," LAMBDA=6 !END")')FACTOR*RCOV
WRITE(NFIL,FMT='("  !WAVE L=2 E=0. PSTYPE=''HBS'' RC=",F5.3," LAMBDA=6 !END")')FACTOR*RCOV

WRITE(NFIL,FMT='("  !WAVE L=0 E=1. PSTYPE=''HBS'' RC=",F5.3," LAMBDA=6 !END")')FACTOR*RCOV
WRITE(NFIL,FMT='("  !WAVE L=1 E=1. PSTYPE=''HBS'' RC=",F5.3," LAMBDA=6 !END")')FACTOR*RCOV
WRITE(NFIL,FMT='("  !WAVE L=2 E=1. PSTYPE=''HBS'' RC=",F5.3," LAMBDA=6 !END")')FACTOR*RCOV
