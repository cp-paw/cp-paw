      ...
      DO ISPIN=1,NSPIN
        DO I=1,NG
          DO IDIM1=1,NDIM
            ...
            HPSI1(:,:,:)=0.0D0
PRINT*,'BEFORE VPSI',NRG,NR1,NR2,NR3
!THERE IS A BUG THAT MESSES UP THE BANDDATA FILE IF THE WRITING 
!ROUTINE IS PARALLELIZED. AS A CONSEQUENCE NRG IS NOT NR1*NR2*NR3,
!BECAUSE THE LOCAL NRL IS WRITTEN INSTEAD OF THE GLOBAL NRG.
