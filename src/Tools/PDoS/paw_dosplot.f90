...
!
      ...
      IF(.NOT.TCHK) THEN
        CALL ERROR$MSG('!DPCNTL:XMIN IS MANDATORY INPUT')
        CALL ERROR$STOP('READCNTL')
      END IF
      CALL LINKEDLIST$GET(LL_CNTL,'XMIN',0,XMIN)
!
      CALL LINKEDLIST$EXISTD(LL_CNTL,'XMAX',1,TCHK)
      IF(.NOT.TCHK) THEN
        CALL ERROR$MSG('!DPCNTL:XMAX IS MANDATORY INPUT')
        CALL ERROR$STOP('READCNTL')
      END IF
      CALL LINKEDLIST$GET(LL_CNTL,'XMAX',0,XMAX)
...
!      
       ELSE
         ...
         CALL GRACE_MAPCOLOR(NFIL,I,  0,255,  0,'GREEN')  ; I=I+1
         ...
         CALL GRACE_MAPCOLOR(NFIL,I,240,240,  0,'YELLOW') ; I=I+1
         CALL GRACE_MAPCOLOR(NFIL,I,255,255,150,'LYELLOW') ; I=I+1
         CALL GRACE_MAPCOLOR(NFIL,I,  0,240,240,'CYAN')   ; I=I+1
         ...
         CALL GRACE_MAPCOLOR(NFIL,I,255,165,150,'LORANGE') ; I=I+1
         CALL GRACE_MAPCOLOR(NFIL,I,200,150,150,'BROWN')  ; I=I+1
         CALL GRACE_MAPCOLOR(NFIL,I,155,155,  0,'GOLD')   ; I=I+1
         CALL GRACE_MAPCOLOR(NFIL,I,155,155,100,'LGOLD')   ; I=I+1
         CALL GRACE_MAPCOLOR(NFIL,I,  0,155,  0,'DARKGREEN')   ; I=I+1
         CALL GRACE_MAPCOLOR(NFIL,I,100,155,100,'LDARKGREEN')   ; I=I+1
...
!      *************************************************************************
       ...
       PRINT*,'EXECUTE WITH THE FOLLOWING COMMAND:'
       PRINT*,-'XMGRACE -NOSAFE -BATCH ',TRIM(GRBFILE)
       PRINT*,-'XMGRACE -NOSAFE -HDEVICE '//+'EPS'//-' -BATCH ',TRIM(GRBFILE) &
      &         ,-' -HARDCOPY -PRINTFILE FILE.EPS'
       PRINT*,-'XMGRACE -NOSAFE -HDEVICE '//+'PDF'//-' -BATCH ',TRIM(GRBFILE) &
      &         ,-' -HARDCOPY -PRINTFILE FILE.PDF'
       PRINT*,-'XMGRACE -NOSAFE -HDEVICE '//+'SVG'//-' -BATCH ',TRIM(GRBFILE) &
