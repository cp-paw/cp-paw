...
!     == MINUS SIGN INDICATS ANGSTROM-UNIT. OTHERWISE BOHR RADII ===============
      WRITE(NFIL,FMT='(I5,3F12.6)')SUNIT*N1,BOX(:,1)/REAL(N1,KIND=8)*SCALE
      WRITE(NFIL,FMT='(I5,3F12.6)')SUNIT*N2,BOX(:,2)/REAL(N2,KIND=8)*SCALE
      WRITE(NFIL,FMT='(I5,3F12.6)')SUNIT*N3,BOX(:,3)/REAL(N3,KIND=8)*SCALE
!
      DO IAT=1,NAT
