...
!
!     .......................................................SPHLSD.....
      SUBROUTINE OLDRADIAL$DERIVE(R1,DEX,NR,F,G)
!     **                                                              **
...
!
!     .....................................................INTRAD.......
      SUBROUTINE OLDRADIAL$INTEGRATE(R1,DEX,NR,F1,G)
!     **                                                              **
...
!
!     .....................................................INTRAD.......
      SUBROUTINE OLDRADIAL$INTEGRAL(R1,DEX,NR,F1,RES)
!     ******************************************************************
!     **                                                              **
...
!
!     .....................................................INTRAD.......
      SUBROUTINE OLDRADIAL$INTEGRAL1(R1,DEX,NR,F1,RAD,VAL)
!     ******************************************************************
!     **                                                              **
...
!
!     .....................................................INTRAD.......
      SUBROUTINE OLDRADIAL$INTEGRAL2(R1,DEX,NR,F1,R,RES)
!     ******************************************************************
!     **                                                              **
!     **  INTEGRATES THE RADIAL FUNCTION F(R) FROM 0 TO GRID POINT NR **
!     **  WHERE F IS GIVEN ON A LOGHARITHMIC MESH                     **
...
CALL ERROR$STOP('OLDRADIAL$INTEGRAL2')
      IF(NR.LT.10) THEN
        CALL ERROR$MSG('NUMBER OF MESHPOINTS SMALLLER THAN 10')
        CALL ERROR$STOP('INTGRL')
      END IF
...
!
!     ....................................................................
      SUBROUTINE OLDRADIAL$VALUE(R1,DEX,NR,FI_,R0,F0)
!     **                                                                **
!     **  POLYNOMIAL EXTRAPOLATION OF ORDER NP FROM NP POINTS (RI,FI_)  **
!     **  TO THE POINT (R0,F0)                                          **
!     **                                                                **
...
!       ****************************************************************
      ...
      END SUBROUTINE OLDRADIAL$VALUE
!
!     ..................................................................
      SUBROUTINE OLDRADIAL$DERIVATIVE(R1,DEX,NR,FI_,R0,F0)
!     ******************************************************************
...
!           == DO NOT CHANGE THE ORDER OF THE NEXT TWO STATEMENTS ======
      ...
      END SUBROUTINE OLDRADIAL$DERIVATIVE
!
!     .....................................................POISON.......
      SUBROUTINE OLDRADIAL$POISSON(R1,DEX,NR,L,RHO,V)
!     ******************************************************************
!     **                                                              **
...
!
      ...
      ENDDO
!
      CALL OLDRADIAL$INTEGRATE(R1,DEX,NR,AUX1,AUX2)
!
...
!
!     ...........................................MLTPOL.................
      SUBROUTINE OLDRADIAL$MOMENT(R1,DEX,NR,L,RHO,QLM)
!     ******************************************************************
!     **                                                              **
...
!     ******************************************************************
      ...
      ENDDO
      CALL OLDRADIAL$INTEGRAL(R1,DEX,NR,AUX1,QLM)
      RETURN
      END
!
!.......................................................................
