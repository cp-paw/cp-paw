...
!     **************************************************************************
     ...
     &                             ,STATUS=STATUS)
      ...
      IF(GPU_RECOMMENDED_ENABLED) RESIDENCY_STACK_ENABLED=.TRUE.
     ...
     &    ,RESIDENCY_STACK_ENABLED,FOUND)
      IF(FOUND.AND.(.NOT.RESIDENCY_STACK_ENABLED)) &
     &  GPU_RECOMMENDED_ENABLED=.FALSE.
      ...
      IF(GPU_RECOMMENDED_ENABLED) THEN
        PROJECTION_STACK_ENABLED=.TRUE.
        ADDPRO_STACK_ENABLED=.TRUE.
        VPSI_HPSI_RTOG_RESIDENCY_ENABLED=.TRUE.
        VPSI_INTERNAL_RESIDENCY_ENABLED=.TRUE.
        DENSITY_INTERNAL_RESIDENCY_ENABLED=.TRUE.
        ONECENTER_OVERLAP_BATCH_ENABLED=.TRUE.
        ORTHO_ADDOPROJ_ENABLED=.TRUE.
        FORCE_ADDOPROJ_ENABLED=.TRUE.
      END IF
