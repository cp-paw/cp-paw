...
!ENDDO
      ...
      CALL ERROR$MSG('1) REDUCE PLANE WAVE CUTOFF')
      CALL ERROR$MSG('2) REDUCE TIME STEP WHILE KEEPING WAVE FUNCTION MASS')
      CALL ERROR$MSG('3) CHECK FOR GHOST STATES')
...
!     ..................................................................
      ...
      DO ISP=1,NSP_
        CALL SETUP$ISELECT(ISP)
        PROOFG_(:,:,ISP)=0.0D0
        PROOFG_(:,1:THIS%LNX,ISP)=THIS%PROOFG(:,:)
        CALL SETUP$unSELECT()
      ENDDO
