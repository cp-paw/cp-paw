...
#IF DEFINED(CPPVAR_ACCEL_PROFILE)
      ACCEL_BYTES=REAL(LENG,KIND=8)*REAL(STORAGE_SIZE(VAL1(1))/8,KIND=8)
...
#IF DEFINED(CPPVAR_ACCEL_PROFILE)
      ...
      CALL ACCELPROFILE$ADD('MPI_ALLTOALL_<TYPEID><RANKID>' &
     & ,INT(LENG1,KIND=8),INT(NTASKS,KIND=8),INT(LENG,KIND=8),0_8 &
