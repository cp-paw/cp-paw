...
!     **************************************************************************
     ...
     &                             ,LINKEDLIST$SIZE 
      ...
      CHARACTER(32)            :: DEVICE
      INTEGER(4)               :: DEVICEINDEX,RADIALPOINTS,LEBEDEVEXACTNESS
      INTEGER(4)               :: LEBEDEVORIENTATIONS
      INTEGER(4)               :: LEN
...
!     ==========================================================================
      ...
      IF(TCHK2) THEN
        ...
        RADIALPOINTS=200
        CALL LINKEDLIST$EXISTD(LL_CNTL,'RADIALPOINTS',1,TCHK1)
        IF(TCHK1) CALL LINKEDLIST$GET(LL_CNTL,'RADIALPOINTS',1,RADIALPOINTS)
        CALL SKALA$SETI4('RADIALPOINTS',RADIALPOINTS)
        LEBEDEVEXACTNESS=53
        CALL LINKEDLIST$EXISTD(LL_CNTL,'LEBEDEVEXACTNESS',1,TCHK1)
        IF(TCHK1) THEN
          CALL LINKEDLIST$GET(LL_CNTL,'LEBEDEVEXACTNESS',1 &
     &                       ,LEBEDEVEXACTNESS)
        END IF
        CALL SKALA$SETI4('LEBEDEVEXACTNESS',LEBEDEVEXACTNESS)
        LEBEDEVORIENTATIONS=1
        CALL LINKEDLIST$EXISTD(LL_CNTL,'LEBEDEVORIENTATIONS',1,TCHK1)
        IF(TCHK1) THEN
          CALL LINKEDLIST$GET(LL_CNTL,'LEBEDEVORIENTATIONS',1 &
     &                       ,LEBEDEVORIENTATIONS)
        END IF
        CALL SKALA$SETI4('LEBEDEVORIENTATIONS',LEBEDEVORIENTATIONS)
        TCHK1=.FALSE.
        CALL LINKEDLIST$EXISTD(LL_CNTL,'APPLY',1,TCHK)
        IF(TCHK) CALL LINKEDLIST$GET(LL_CNTL,'APPLY',1,TCHK1)
        CALL SKALA$SETL4('APPLY',TCHK1)
        TCHK1=.TRUE.
        CALL LINKEDLIST$EXISTD(LL_CNTL,'APPLYSMOOTH',1,TCHK)
        IF(TCHK) CALL LINKEDLIST$GET(LL_CNTL,'APPLYSMOOTH',1,TCHK1)
        CALL SKALA$SETL4('APPLYSMOOTH',TCHK1)
        TCHK1=.TRUE.
        CALL LINKEDLIST$EXISTD(LL_CNTL,'APPLYTAU',1,TCHK)
        IF(TCHK) CALL LINKEDLIST$GET(LL_CNTL,'APPLYTAU',1,TCHK1)
        CALL SKALA$SETL4('APPLYTAU',TCHK1)
        TCHK1=.TRUE.
        CALL LINKEDLIST$EXISTD(LL_CNTL,'APPLYONECENTER',1,TCHK)
        IF(TCHK) CALL LINKEDLIST$GET(LL_CNTL,'APPLYONECENTER',1,TCHK1)
        CALL SKALA$SETL4('APPLYONECENTER',TCHK1)
        TCHK1=.FALSE.
        CALL LINKEDLIST$EXISTD(LL_CNTL,'INTERPOLATEPARTITION',1,TCHK)
        IF(TCHK) THEN
          CALL LINKEDLIST$GET(LL_CNTL,'INTERPOLATEPARTITION',1,TCHK1)
        END IF
        CALL SKALA$SETL4('INTERPOLATEPARTITION',TCHK1)
        TCHK1=.FALSE.
        CALL LINKEDLIST$EXISTD(LL_CNTL,'DISTRIBUTEGPU',1,TCHK)
        IF(TCHK) CALL LINKEDLIST$GET(LL_CNTL,'DISTRIBUTEGPU',1,TCHK1)
        CALL SKALA$SETL4('DISTRIBUTEGPU',TCHK1)
        TCHK1=.FALSE.
        CALL LINKEDLIST$EXISTD(LL_CNTL,'CHECK',1,TCHK)
        IF(TCHK) CALL LINKEDLIST$GET(LL_CNTL,'CHECK',1,TCHK1)
        CALL SKALA$SETL4('CHECK',TCHK1)
        CALL LINKEDLIST$SELECT(LL_CNTL,'..')
      END IF
!
!     ==========================================================================
