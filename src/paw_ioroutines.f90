...
!
!     == IF OCCUPATIONS ARE NOT DYNAMICAL THE OCCUPATIONS ARE NOT READ
!     == FROM THE RESTART FILE BUT RECONSTRUCTED FROM THE STRUC INPUT FILE
      CALL DYNOCC$SETL4('START',.TRUE.)
!
!     ==================================================================
...
!     == FROM THE RESTART FILE UNLESS THE PARAMETER START=T IS SPECIFIED 
!     ==  ON INPUT IN THIS !CNTL!MERMIN BLOCK
      CALL DYNOCC$SETL4('START',.FALSE.)
!
...
!     == RESTART WITH OCCUPATIONS FROM STRC FILE =======================
      ...
      CALL DYNOCC$SETL4('RESTART',TCHK)
!
