...
\bigskip\fbox{{\tt paw\_get\_energy\ }\textit{ROOTNAME}}
...
\bigskip\fbox{{\tt paw\_get\_gap\ }\textit{ROOTNAME}}
...
\bigskip\fbox{{\tt paw\_get\_homo\ }\textit{ROOTNAME}}
...
\bigskip\fbox{{\tt paw\_get\_lumo\ }\textit{ROOTNAME}}
