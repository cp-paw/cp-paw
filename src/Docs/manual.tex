...
\mbax{\key{PREFIX} 
\vdescr{Default for the prefix used in this graph. The name of the density of states data
...
\mbax{\key{SCALE}
\vdescr{default value for the scale factor of the Density of States used in this graph}
\vformat{real} 
\vrules{optional}
\vdefault{1.}}
...
\vformat{character} 
\vrules{optional}
\vdefault{Default is defined by !DCNTL!GRAPH:PREFIX}}

\mbax{\key{SCALE}
\vdescr{scale factor of the Density of States used in this graph}
\vformat{real} 
\vrules{optional}
\vdefault{Default is defined by !DCNTL!GRAPH:SCALE}}
...
name   &RGB &name   &RGB \\
\hline
black     & (0,0,0)     & lblack & (150,150,150) \\
red       & (255,0,0)   & lred   & (255,150,150) \\
green     & (0,255,0)   & lgreen  & (150,255,150) \\
blue      & (0,0,255)   & lblue  & (150,150,255) \\
yellow    & (240,240,  0)   & lyellow     & (255,255,150) \\
cyan      & (  0,240,240)   & lcyan       & (150,255,255) \\
magenta   & (255,  0,255)   & lmagenta    & (255,150,255) \\
orange    & (255,165,  0)   & lorange     & (255,165,150,) \\
brown     & (200,150,150)   & lbrown      & (255,200,200) \\
gold      & (155,155,  0)   & lgold       & (155,155,100) \\
darkgreen & (  0,155,  0)   & ldarkgreen  & (100,155,100) \\
\hline
\end{tabular}
\end{center}
}
...
\begin{verbatim}
!BCNTL
  !LINE FILE='BANDS_gammax.DAT' SPIN=1
    XK1= 0. 0. 0. XK2= .5 0. 0. NK=101 
...
The bands are written in the format \centerline{$ik e_1(ik) e_2(ik)
  e_3(ik) \ldots$} onto the specified band. $ik$ is the index of the
k-point along the line from xk1 to xk2. $e_j(ik)$ is the energy
eigenvalue of the j-th band.
...
in relative coordinates of the reciprocal lattice vectors.}
\vformat{real(3)} 
\vrules{optional}
\vdefault{(0.,0.,0.)}}
...
%==========================================================================
The bands are interpolated between the grid points using a linear
