...
\mbax{\key{MODE}
\vdescr{defines the mode for the calculation of the density of states: GAUSSIAN
defines the calculation via a simple gaussian broadening of the energy states.
TETRA denotes the calculation using the tetrahedron integration.}
\vformat{character} 
\vrules{optional}
\vdefault{GAUSSIAN}}
...
%====================================================================
We refer the user to International Tables for Crystallography, Vol. A chapter
12.2.
%====================================================================
\newpage
