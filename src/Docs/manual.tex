...
\bdescr{(presently in test phase:\\
  ...
  it starts acting only when the wave function kinetic exceeds the
  target temperature estimated for Born-Oppenheimer kinetic
  energy.\cite{bloechl02_prb65_104303} If the thermostat kicks in, it
  reshuffles kinetic energy from the wave functions into the atomic
  motion.  The target kinetic energy is subtracted from the wave
  function kinetic energy in the protocol. A friction on the
  thermostat shall be used to avoid instabilities. The thermostat
  shall be used only if the atoms are moving.} 
...
\mbax{\key{DR} 
\vdescr{grid spacing for the output file. It is rounded to get an integer factor
relative to the real-space grid used in the calculation.} 
\vformat{real} 
\vrules{optional}
\vdefault{0.4}}
...
\mbax{\key{ID}
\vdescr{Identifier of the file. Can be 'STRC', 'WAVE', 'WAVEDX', 'CUBE'.}
\vformat{character} 
\vrules{mandatory}
\vdefault{none}}
...
%==========================================================================
\subsection{Contour plots and rubbersheets using Gnuplot}
%==========================================================================
If a plane has been sepcified in !WCNTL, an input file for Gnuplot is
generated with default name rubbersheet.gnu.

A plot is generated by the command
\begin{center}
  gnuplot rubbersheet.gnu
\end{center}

The resulting file will look like
\begin{center}
\includegraphics[width=0.5\linewidth,clip=true]{Figs/rubgnu.eps}
\end{center}

Usually, this plot is not what one wants. Therefore we need to enter
the gnuplot file rubbersheet.gnu. The top part looks something like
the following:
\begin{verbatim}
 #
 #============================================================
 ...
 set dgrid3d  60,60,1 #SAMPLE INPUT DATA ONTO A 60X60 GRID
 #
 #============================================================
 # SURFACE PLOT                                             ==
 #============================================================
