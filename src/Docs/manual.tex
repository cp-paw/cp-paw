...
\begin{eqnarray*}
n_s&=&\sqrt{Q^2+\left(\vec{\sigma}^2}-Q^2)}
=Q\sqrt{1+\left(\frac{\vec{\sigma}^2}{Q^2}-1)}
\\
&=&Q\Bigl[1+\frac{1}{2}\left(\frac{\vec{\sigma}^2}{Q^2}-1)
-\frac{1}{8}\left(\frac{\vec{\sigma}^2}{Q^2}-1)^2+\ldots
\end{eqnarray*}
