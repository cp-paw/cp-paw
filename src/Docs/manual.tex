...
\mbax{\key{VDW}
\vdescr{Adds van der Waals Interactions\cite{grimme10_jcp32_154104}. 
...
\mbax{\key{VDW-3BODY} 
\vdescr{adds three-body interactions\cite{grimme10_jcp32_154104} to
...
\bdescr{Describes the treatment of variable occupations of the one-electron
  ...
  method\footnote{The original papers on the tetrahedron method ar by
    ...
    Lehman/Taut\cite{lehmann72_pssb54_463}. The improved tetrahedron
