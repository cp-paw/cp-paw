...
!       == SELECTOR (NONE, EMINMAX ,BMINMAX)
        CALL LINKEDLIST$EXISTD(LL_CNTL,'EMIN',1,TCHK1)
        ...
        IF(TCHK1) THEN
          ...
          EMIN=-1.D+10
          EMAX=+1.D+10
          CALL LINKEDLIST$GET(LL_CNTL,'EMIN',1,EMIN)
          CALL LINKEDLIST$GET(LL_CNTL,'EMAX',1,EMAX)
        ...
        ELSE IF(TCHK2) THEN
          ...
          CALL GRAPHICS$SETR8('IBMIN',IBMIN)
          CALL GRAPHICS$SETR8('IBMAX',IBMAX)
        ELSE
