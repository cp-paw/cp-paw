!
!     ...1.........2.........3.........4.........5.........6.........7.........8
      SUBROUTINE ATOMLIB$AESCF(GID,NR,KEY,RBOX,AEZ,NX,NB,LOFI,SO,F,NN,ETOT,POT,EOFI,PHI)
!     **************************************************************************
...
!       ==========================================================================
        DO IB=1,NB
          ...
          ELSE 
            DREL(:)=0.D0 
          END IF
          CALL atomlib$BOUNDSTATE(GID,NR,LOFI(IB),SO(IB),RBOX,DREL,G,NN(IB),POT,EOFI(IB),PHI(:,IB))
          AUX(:)=(R(:)*PHI(:,IB))**2
