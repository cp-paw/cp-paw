...
!     *******************************************P.E. BLOECHL, (1991)***********
     ...
     &     ,SERIAL3D_ACC_INPUT_PRESENT_HINT &
     &     ,SERIAL3D_ACC_OUTPUT_PRESENT_HINT
#IF DEFINED(CPPVAR_CUBLAS_ACC)
      USE OPENACC
      USE CPPAW_CUBLAS_ACC_MODULE, ONLY: &
     &       CPPAW_CUBLAS_ACC_HPSI_RESIDENCY_ENABLED &
...
#ENDIF
#IF DEFINED(CPPVAR_CUBLAS_ACC)
          IF(TACC_PSIOFR_DEVICE.AND.TACC_HPSI_RTOG_RESIDENT) THEN
            SERIAL3D_ACC_INPUT_PRESENT_HINT=.TRUE.
            SERIAL3D_ACC_OUTPUT_PRESENT_HINT=.TRUE.
          END IF
#ENDIF
          CALL PLANEWAVE$FFT('RTOG',NDIM,NGL,HPSI(:,:,IB),NRL,PSIOFR)
#IF DEFINED(CPPVAR_CUBLAS_ACC)
          SERIAL3D_ACC_INPUT_PRESENT_HINT=.FALSE.
          SERIAL3D_ACC_OUTPUT_PRESENT_HINT=.FALSE.
#ENDIF
#IF DEFINED(CPPVAR_CUBLAS_ACC)
