...
!!$PRINT*,'MARKE HAMILTON ',HAMILTON
!!$PRINT*,'MARKE EIGVAL ',THIS%EIGVAL
!!$PRINT*,'MARKE EIGVEC ',THIS%EIGVEC
CALL TRACE$PASS('BEFORE LIB$DIAGC8 PRODUCING SIGILL')
            CALL LIB$DIAGC8(NB,HAMILTON,THIS%EIGVAL,THIS%EIGVEC)
CALL TRACE$PASS('AFTER LIB$DIAGC8 PRODUCING SIGILL')
            DEALLOCATE(HAMILTON)
!
!           ====================================================================
