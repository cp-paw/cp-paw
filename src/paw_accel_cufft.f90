...
!     **************************************************************************
     ...
     &                             ,STATUS=STATUS)
      IF(STATUS.EQ.0) THEN
        ...
        IF(IOS.NE.0) MINELEMENTS=512.D0
      END IF
...
!
!     ..........................................................................
      SUBROUTINE CPPAW_CUFFT_ACC_3DFFTC8_PRESENT(DIR,N1,N2,N3,Y,USED)
      IMPLICIT NONE
      CHARACTER(*),INTENT(IN) :: DIR
      INTEGER(4)  ,INTENT(IN) :: N1
      INTEGER(4)  ,INTENT(IN) :: N2
      INTEGER(4)  ,INTENT(IN) :: N3
      COMPLEX(8)  ,INTENT(INOUT):: Y(N1,N2,N3)
      LOGICAL(4)  ,INTENT(OUT):: USED
      INTEGER(4)              :: PLAN
      INTEGER(4)              :: DIRECTION
      INTEGER(4)              :: ISTAT
...
!     **************************************************************************
      ...
      IF(ISTAT.NE.0) THEN
        CALL ERROR$MSG('CUFFTSETSTREAM FAILED')
        CALL ERROR$I4VAL('STATUS',ISTAT)
        CALL ERROR$STOP('CPPAW_CUFFT_ACC_3DFFTC8_PRESENT')
      END IF
#IF DEFINED(CPPVAR_ACCEL_PROFILE)
      CALL ACCELPROFILE$NOW(ACCEL_T0)
#ENDIF
...
#IF DEFINED(CPPVAR_ACCEL_PROFILE)
      ...
      CALL ACCELPROFILE$ADD('CUFFT3D_C8_PRESENT' &
     & ,INT(N1,KIND=8),INT(N2,KIND=8),INT(N3,KIND=8),0_8 &
     & ,5.D0*ACCEL_N*LOG(ACCEL_N)/LOG(2.D0),0.D0,ACCEL_T1-ACCEL_T0)
#ENDIF
      USED=.TRUE.
      RETURN
      END SUBROUTINE CPPAW_CUFFT_ACC_3DFFTC8_PRESENT
!
