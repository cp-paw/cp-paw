...
!     ==================================================================
      CALL ISOLATE_A(NGS,NAT,RBAS,ET,POS,FORCET,GvecS,ngamma,RHOS &
     &              ,LMRXX,QLM,VQLMT,NFCT,F,RC,RCSM)
      DEALLOCATE(F)
      DEALLOCATE(GvecS)
...
!
!     ..................................................................
      SUBROUTINE ISOLATE_A(NGS,NAT,RBAS,E,BAS,FORCE,G,ngamma,RHO &
     &                    ,LMRXX,QLM,VQLM,NFCT,F,RC,RCSM)
!     ******************************************************************
!     ******************************************************************
      USE MPE_MODULE
      implicit none
...
!CALL DCOPY(NAT*NFCT*NAT*NFCT,GG,1,GGINV,1)
!NAUX=100*NAT*NFCT
!ALLOCATE(WORK1(NAUX))
!ALLOCATE(WORK2(2))
!CALL DGEICD(GGINV,NAT*NFCT,NAT*NFCT,0,RCOND,WORK2,WORK1,NAUX)
!DEALLOCATE(WORK2)!DEALLOCATE(WORK1)
!
...
!
      ...
      WRITE(*,FMT='("DTOT",F10.5,"DEBYE; DIRECTION: (",3F3.0,")")') &
