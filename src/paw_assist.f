...
TYPE(CONTROL_TYPE)   :: CONTROL(NAUTOX) &
          & =(/coNTROL_TYPE('WAVES',.FALSE.,0.D0,1.D0,0.D0,1.D0) &
          &   ,CONTROL_TYPE('ATOMS',.FALSE.,0.D0,1.D0,0.D0,1.D0) &
          &   ,CONTROL_TYPE('OCC',.FALSE.,0.D0,1.D0,0.D0,1.D0) &
          &   ,CONTROL_TYPE('QM-MM',.FALSE.,0.D0,1.D0,0.D0,1.D0) &
          &   ,CONTROL_TYPE('CONTINUUM',.FALSE.,0.D0,1.D0,0.D0,1.D0)/)
INTEGER(4)           ::NAUTO=NAUTOX
LOGICAL(4) :: TINI=.FALSE.
LOGICAL(4) :: TAUTO=.FALSE.  ! switch(autopilot on/off)
LOGICAL(4) :: TFIRST=.FALSE.
...
!     ==================================================================
      DO I=1,NAUTO
        ...
        ELSE IF(CONTROL(I)%NAME.EQ.'CONTINUUM') THEN
          CALL CONTINUUM$SETR8('FRICTION',FRICTION)
        END IF
      ENDDO
      EPREV=ETOT
      RETURN
