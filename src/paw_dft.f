...
!     ==================================================================
      IF(IT.EQ.0) THEN
        TGRATARGET=.FALSE.
        DESCRIPTION(1)='no ex change or correlation'
...
!
!     .....................................................DFT..........
      SUBROUTINE DFT$SETL4(IDENT_,VALUE)
!     ******************************************************************
!     ******************************************************************
      USE DFT_MODULE
      IMPLICIT NONE
...
!
!     .....................................................DFT..........
      SUBROUTINE DFT$GETL4(IDENT_,VALUE)
!     ******************************************************************
!     ******************************************************************
      USE DFT_MODULE
      IMPLICIT NONE
...
!     ******************************************************************
      IF(IDENT_.EQ.'GC') THEN
        VALUE=TGRA
      ELSE IF(IDENT_.EQ.'SPIN') THEN
        VALUE=TSPIN
      ELSE
        CALL ERROR$MSG('IDENTIFIER NOT RECOGNIZED')
        CALL ERROR$CHVAL('IDENT_',IDENT_)
...
!     .................................................................
      ...
      USE EXCHANGE_MODULE,ONLY : TSIMPLE,MU,KAPPA,MUBYKAPPA,ALPHAB2
      IMPLICIT NONE
      REAL(8),INTENT(IN) :: S2
...
!     ******************************************************************
      ...
      REAL(8)              :: SIGMAM13,SIGMAM23,SIGMAM43
      REAL(8)              :: F,DF,D2F
      REAL(8)              :: SIG_R,SIG_S,SIG_RR,SIG_RS,SIG_SS
...
!     ******************************************************************
      ...
      REAL(8)                 :: A,A_R,A_S
      REAL(8)                 :: B,B_R,B_W
      REAL(8)                 :: SVAR1,SVAR2,SVAR3,FAC1,FAC2
      REAL(8)                 :: DEXC
      REAL(8)                 :: GVXCT1,VXCT1
      REAL(8)                 :: SVAR
!     *******************************************************************
...
!      *****************************************************************    
       ...
       REAL(8)            :: H_V,H_TV,H_VV,H_VG
       REAL(8)            :: H_TTV,H_TVV,H_TVG,H_VVV,H_VVG,H_VGG,H_GGG
!      *****************************************************************    
!
!      =================================================================
!      ==  CONSTANTS                                                  ==
