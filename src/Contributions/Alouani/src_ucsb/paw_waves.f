...
!MEA 08-04-2002 
        IF (ABS(XK(1,IKPT)) + ABS(XK(2,IKPT)) + ABS(XK(3,IKPT))<=1.D-8) THEN
        PRINT*,' BEFORE BRICE FOR LATTICE' 
        CALL OPTIC3$LATTICE 
        PRINT*,'AFTER BRICE'
        ENDIF 
!END MEA 
...
! 08-04-2002 
!=========================================
!==  SEND DH(I,J) AND DO(I,J)  TO OPTIC == 
!=========================================

!      CALL OPTIC3$DH(NDIMD,LMNX,NAT,IAT,DH1)
!      CALL OPTIC3$DO(NDIMD,LMNX,NAT,IAT,DOV1)
! BENGONE MODIFY END 
...
!**********************************************************************
!       MODIFIE PAR BRICE
!       VALABLE POUR LA VERSION SEQUENTIELLE
!**********************************************************************

        CALL OPTIC3$WRITEOUT_PARTIALS(NDIMD,NAT,LMNXX,DH,DO)
...
! 08-04-2002 
!=========================================
!==   SEND DH HAMILTONIAN TO OPTIC      == 
!=========================================

!     DO IAT=1,NAT 
!       ISP=MAP%ISP(IAT)
!       LMNX=MAP%LMNX(ISP)
!      CALL OPTIC3$DH(NSPIN,LMNX,NAT,IAT,DH(1:LMNX,1:LMNX,1:2,IAT)
!      CALL OPTIC3$DO(NSPIN,LMNX,NAT,IAT,DO(1:LMNX,1:LMNX,1:2,IAT)
!     ENDDO !(IAT) 
