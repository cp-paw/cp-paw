...
!***********************************************************************
!     MODIFICATION APPORTEE PAR BRICE 08-04-2002 
!***********************************************************************
!     CALL OPTIC3$REQUEST(TEST)
!     IF (OPTIC) THEN
         CALL OPTIC3$VXCG_VALENCE(TGRA,NSPIN,NRL,NRL,NR1GLOB*NR2*NR3, &
...
!MEA 08-04-2002 
            CALL OPTIC3$VXCG_CORE(TGRA,NSPIN,NRL,NRL,NR1GLOB*NR2*NR3, &
...
!MEA 08-04-2002 
            CALL OPTIC3$VXCG(NR1,NR2,NR3,NGL,RHOG,NSPIN)
!END MEA 08-04-2002 
!
!     ==================================================================
...
!MEA 08-04-2002   
      CALL OPTIC3$VOFG(NR1,NR2,NR3,NGL,RHOG,NSPIN)
!END MEA   
!
!     ==================================================================
