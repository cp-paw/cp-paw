...
! WHERE U IS THE M[C12]/12.
REAL(8)     ,PARAMETER:: RNUCFAC=1.85635065215D-4
!**********************************************************************
CONTAINS
!
!     .............................................FUNCTION TFAPOT......
...
!     == LANTHANIDES - 4F RARE EARTHS ==============================
      ...
      SET( 64)=SET_TYPE('GD',157.25   ,1.61,3.368,1.20,(/2,0,0,8/),'XE')
...
!     ==================================================================
      ...
      DO I=0,NEL
        ...
        ELEMENT(I)%RVDW=SET(I)%RVDW*ANGSTROM
