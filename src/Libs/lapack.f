...
!== this routine exists already in blas
      SUBROUTINE DTRSM_lapack( SIDE, UPLO, TRANSA, DIAG, M, N, ALPHA, A, 
     $          LDA,
     $                   B, LDB )
*     .. Scalar Arguments ..
...
*
      END
!     ==== this routine already exists in blas
...
*
      END
c$$$!this routine is repeated
c$$$      SUBROUTINE DLARF( SIDE, M, N, V, INCV, TAU, C, LDC, WORK )
c$$$*
...
c$$$*     .. Scalar Arguments ..
c$$$      CHARACTER          SIDE
c$$$      INTEGER            INCV, LDC, M, N
c$$$      DOUBLE PRECISION   TAU
c$$$*     ..
c$$$*     .. Array Arguments ..
c$$$      DOUBLE PRECISION   C( LDC, * ), V( * ), WORK( * )
c$$$*     ..
c$$$*
c$$$*  Purpose
c$$$*  =======
...
c$$$*
c$$$      IF( LSAME( SIDE, 'L' ) ) THEN
c$$$*
c$$$*        Form  H * C
c$$$*
c$$$         IF( TAU.NE.ZERO ) THEN
c$$$*
c$$$*           w := C' * v
c$$$*
c$$$            CALL DGEMV( 'Transpose', M, N, ONE, C, LDC, V, INCV, ZERO,
c$$$     $                  WORK, 1 )
c$$$*
c$$$*           C := C - v * w'
c$$$*
c$$$            CALL DGER( M, N, -TAU, V, INCV, WORK, 1, C, LDC )
c$$$         END IF
c$$$      ELSE
c$$$*
c$$$*        Form  C * H
...
c$$$*           w := C * v
c$$$*
c$$$            CALL DGEMV( 'No transpose', M, N, ONE, C, LDC, V, INCV,
c$$$     $                  ZERO, WORK, 1 )
c$$$*
c$$$*           C := C - w * v'
c$$$*
c$$$            CALL DGER( M, N, -TAU, WORK, 1, V, INCV, C, LDC )
c$$$         END IF
c$$$      END IF
c$$$      RETURN
c$$$*
