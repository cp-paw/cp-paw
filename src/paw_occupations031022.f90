...
!**      restarttype='                                                **
!**                                                                   **
!**    Four different restarttypes are possible                       **
...
character(32) :: starttype     ! can be 'n','e','o'
...
!      *****************************************************************
       DO ISPIN=1,NSPIN
         TOT=TOTCHA+0.5D0*SPINCHA*(3-2*ISPIN)         
         ISVAR=INT(TOT/FMAX)
         X(1:ISVAR,:,ISPIN)=1
         X(ISVAR+1,:,ISPIN)=0
